...
export const components = {
  "Pharmaceutical Products and Services": ["Procurement", "Distribution", "Use"],
  ...
  "Human Resources": ["Human resources policy and strategy", "Human resources management", "Human resources development"],
};
